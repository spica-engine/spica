...
|                [@spica-devkit/storage](https://www.npmjs.com/package/@spica-devkit/storage)                 |                                                                                                                     ![npm (scoped)](https://img.shields.io/npm/v/@spica-devkit/storage?label=version&color=blue) ![npm](https://img.shields.io/npm/dm/@spica-devkit/storage?color=blue)                                                                                                                     |      Development package for the Storage module.       |
|                [@spica-devkit/identity](https://www.npmjs.com/package/@spica-devkit/identity)                 |                                                                                                                     ![npm (scoped)](https://img.shields.io/npm/v/@spica-devkit/identity?label=version&color=blue) ![npm](https://img.shields.io/npm/dm/@spica-devkit/identity?color=blue)                                                                                                                     |      Development package for the Identity module.       |

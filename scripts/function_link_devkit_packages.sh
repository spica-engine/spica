...
echo "Building the database, dashboard,bucket and identity package"
yarn bazel build //stacks/api/function/packages/database:package //stacks/api/function/packages/dashboard:package //stacks/api/function/packages/bucket:package //stacks/api/function/packages/identity:package

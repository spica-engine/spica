...
yarn bazel build //stacks/api/function/packages/database:package //stacks/api/function/packages/bucket:package //stacks/api/function/packages/identity:package //stacks/api/function/packages/storage:package

...
export namespace Http {
    ...
    export class Param extends pb_1.Message {
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): Param {
            const reader = bytes instanceof Uint8Array ? new pb_1.BinaryReader(bytes) : bytes, message = new Param();
            while (reader.nextField()) {
                if (reader.isEndGroup())
                    break;
                switch (reader.getFieldNumber()) {
    ...
    export class WriteHead extends pb_1.Message {
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): WriteHead {
            const reader = bytes instanceof Uint8Array ? new pb_1.BinaryReader(bytes) : bytes, message = new WriteHead();
            while (reader.nextField()) {
                if (reader.isEndGroup())
                    break;
                switch (reader.getFieldNumber()) {
                    ...
                    case 3:
                        ...
                        break;
                    case 4:
                        reader.readMessage(message.headers, () => pb_1.Message.addToRepeatedWrapperField(message, 4, Header.deserialize(reader), Header));
                        break;
                    default: reader.skipField();
                }
            }
    ...
    export class Write extends pb_1.Message {
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): Write {
            const reader = bytes instanceof Uint8Array ? new pb_1.BinaryReader(bytes) : bytes, message = new Write();
            while (reader.nextField()) {
                if (reader.isEndGroup())
                    break;
                switch (reader.getFieldNumber()) {
    ...
    export class Request extends pb_1.Message {
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | undefined {
            const writer = w || new pb_1.BinaryWriter();
            if (this.statusCode)
                writer.writeInt32(1, this.statusCode);
            if (this.statusMessage)
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    ...
                    case 6:
                        ...
                        break;
                    case 7:
                        reader.readMessage(message.headers, () => pb_1.Message.addToRepeatedWrapperField(message, 7, Header.deserialize(reader), Header));
                        break;
                    case 8:
                        reader.readMessage(message.params, () => pb_1.Message.addToRepeatedWrapperField(message, 8, Param.deserialize(reader), Param));
                        break;
                    case 9:
    ...
    export class End extends pb_1.Message {
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): End {
            const reader = bytes instanceof Uint8Array ? new pb_1.BinaryReader(bytes) : bytes, message = new End();
            while (reader.nextField()) {
                if (reader.isEndGroup())
                    break;
                switch (reader.getFieldNumber()) {

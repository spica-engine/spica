...
const modules = [
  ...
  FunctionModule.forRoot({
    logExpireAfterSeconds: args["log-expiration-limit"],
...
if (args["activity-stream"]) {
  modules.push(ActivityModule.forRoot({expireAfterSeconds: args["log-expiration-limit"]}));
}

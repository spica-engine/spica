...
export class IdentityModule {
    ...
    constructor(@Inject(IDENTITY_OPTIONS) options: IdentityOptions, private identityService: IdentityService) {
        ...
        return {
            ...
            imports: [
                JwtModule.register({
                    ...
                    signOptions: {audience: options.audience, issuer: options.issuer, expiresIn: options.expiresIn}
                }),
                SchemaModule.forChild({
                    schemas: [
                        require(`./schemas/identity.json`), 
                        require(`./schemas/identity-create.json`)
                    ]
                })
            ],
            providers: [

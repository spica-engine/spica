...
export class TextEditorComponent implements OnInit, ControlValueAccessor, AfterContentInit {
  ...
  @Input() id = "";
  @Input() config: TextEditorConfig = TextEditorConfig;
  ...
  ngOnInit() {
    ...
    this.editorToolbar.fonts = this.config.fonts ? this.config.fonts : TextEditorConfig.fonts;
  ...
  onTextAreaBlur(event: FocusEvent) {
    ...
    if (
      ...
      (event.relatedTarget as HTMLElement).parentElement.className !== "text-editor-toolbar-set"
    ) {
      this.blur.emit("blur");
    }
  }

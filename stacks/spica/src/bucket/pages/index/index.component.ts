        ...
        setTimeout(() => {
          ...
          const secondPropValue =
            ...
            this.guideObjects = {
              ...
              getWithFilterRulesEngine: {title: "Get Filtered Data (Spica Rules Engine) ", description: "To filter your data, you can use built-in 'Spica Rules' engine in 'filter' [string] query parameter. You can try the live demo below.", url: `${bucketUrl}limit=3&filter=${firstProp}=='${firstPropValue}'`},
              ...
              getOnlyScheduled: {title: "Get Scheduled Data", description: "You can get all scheduled data with using 'shcedule' [boolean] query parameter. You can try the live demo below.", url: `${bucketUrl}?limit=3&schedule=true`},

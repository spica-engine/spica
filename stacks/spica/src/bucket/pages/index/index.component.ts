      ...
      map(response => {
        ...
        setTimeout(() => {
          ...
          const secondPropValue =
            ...
            this.guideObjects = {
              getAllWithLimit: {title: "Get Limited Data", description: "To get all data using limits, simply you can add 'limit' [number] parameter as query params. You can try the live demo below.", url: `${bucketUrl}limit=3`},
              getAllWithSort: {title: "Get Limited Data With Sorting", description: "To sort your dataset, you can add 'sort' [object] parameter as query params. You can try the live demo below. ", url: `${bucketUrl}limit=3&sort={"${firstProp}":1}`},
              getWithFilterMongoDb: {title: "Get Filtered Data (MongoDB Match Aggregation)", description: "To filter your data, you can use MongoDB match aggregations in 'filter' [object] query parameter. You can try the live demo below.", url: `${bucketUrl}limit=3&filter={"${firstProp}":{"$regex":"${firstPropValue}"}}`},
              getWithFilterRulesEngine: {title: "Get Filtered Data (Spica Rules Engine) ", description: "To filter your data, you can use built-in 'Spica Rules' engine in 'filter' [object] query parameter. You can try the live demo below.", url: `${bucketUrl}limit=3&filter={"${firstProp}":{"$regex":"${firstPropValue}"}}`},
              getWithDoubleFilter: {title: "Using Double Filter", description: "You can apply double filter to your requests as well. You can try the live demo below.", url: `${bucketUrl}limit=1&filter={"${firstProp}":{"$regex":"${firstPropValue}"},"${secondProp}":{"$regex":"${secondPropValue}"}}`},
              getOnlyScheduled: {title: "Get Scheduled Data", description: "You can get all scheduled data with using 'shcedule' [boolean] query parameter. You can try the live demo below.", url: `${bucketUrl}paginate=true&limit=3&schedule=true`},
              getDataWithLang: {title: "Get Localized Data", description: "To get localized data, you can use 'Accept-Language' request header. As an example '{Accept-Language: \"en-EN\"}'", url: ``},

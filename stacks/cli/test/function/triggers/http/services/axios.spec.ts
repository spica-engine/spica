import { Axios, AxiosReadValidator, AxiosWriteValidator } from "@spica/cli/src/function/triggers/http/services";
...
describe("Axios", () => {
    ...
    beforeEach(() => {
        emptyFn = ts.factory.createFunctionDeclaration([], [], undefined, "test", [], [], undefined, undefined);
    })

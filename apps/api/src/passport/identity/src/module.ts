...
import * as IdentitySchema from "./schemas/identity.json";
import * as IdentityCreateSchema from "./schemas/identity-create.json";
import * as AuthFactorSchema from "./schemas/authfactor.json";

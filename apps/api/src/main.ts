...
import {DashboardModule} from "@spica/api/src/dashboard";
...
import {VersionControlModule} from "@spica/api/src/versioncontrol";
import {ReplicationModule} from "@spica/api/src/replication";
import {AssetModule} from "@spica/api/src/asset";

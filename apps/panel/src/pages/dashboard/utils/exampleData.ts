import type {DashboardComponentType} from "../../../store/api/dashboardApi";

export const dashboardExamples: Record<DashboardComponentType, string> = {
  line: `{"title": "line title",
  "options": {"legend": {"display": true},"responsive": true},"labels": ["A", "B", "C", "D", "E", "F"],
  ...
  pie: `{
    "title": "pie title",
    "options": { "legend": { "display": true }, "responsive": true },
    "labels": [["piedata", "Sales"], ["In", "Store", "Sales"], "Mail Sales"],
    "data": [300, 500, 100],
    "legend": true,
    "filters": [
      { "key": "begin", "type": "date", "value": "2000-01-01T00:00:00.000Z" },
  ...
  doughnut: `{
    ...
    "options": { "legend": { "display": true }, "responsive": true },
    "labels": ["doughnutdata Sales", "In-Store Sales", "Mail-Order Sales"],

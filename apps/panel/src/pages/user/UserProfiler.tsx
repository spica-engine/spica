...
import { useGetUserProfileQuery, type ProfilerEntry } from "../../store/api/userApi";
...
const UserProfiler = () => {
  ...
  const { data: entries = [], isLoading, isFetching, refetch } = useGetUserProfileQuery(queryParams);
    ...
    <div className={styles.pageContainer}>
      ...
      >
        <FlexElement direction="horizontal" gap={8} alignment="leftCenter">
          ...
          <span style={{ fontSize: "18px", fontWeight: 600 }}>User Profiler</span>
          <span style={{ fontSize: "13px", color: "var(--color-text-secondary)" }}>
            — MongoDB profiler entries for the <code>user</code> collection
          </span>
        </FlexElement>

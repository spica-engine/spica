(function() {
  ...
  (Calendly._util.domReady = function(e) {
    var t = !1,
      n = function() {
  ...
  function() {
    (Calendly._url = {}),
      (Calendly._url.extractQueryStringParams = function(e) {
  ...
  function() {
    ...
    (Calendly._autoLoadInlineWidgets = function() {
      ...
      (Calendly.initInlineWidget = function(e) {
        return e.url
          ? (e.parentElement || (e.parentElement = o()),
      ...
      (Calendly.showPopupWidget = function(e, t, n) {
        ...
        return (
          ...
          (Calendly.popupWidget = new Calendly.PopupWidget(e, o, t, n)),
      ...
      (t = function() {
        var e, t, n, o, r;
        for (
          t = document.querySelectorAll(".calendly-inline-widget"), r = [], n = 0, o = t.length;
          o > n;
          n++
        )
          (e = t[n]),
            i(e)
              ...
              : (e.setAttribute("data-processed", !0),
                r.push(
                  new Calendly.Iframe({parentElement: e, inlineStyles: !0, embedType: "Inline"})
                ));
        return r;
      }),
      (i = function(e) {
      ...
      (e = function(e) {
        ...
        return (
          ...
          (o = Calendly._util.assign({onClick: i}, t)),
      ...
      (n = function(e) {
        var t, n;
        return (
          (t = ["color", "textColor", "text", "branding"]),
          (n = {}),
    ...
    Calendly.Iframe = (function() {
      ...
      return (
        ...
        (e.prototype.parseOptions = function() {
          ...
          if (
            ((e = {inlineStyles: !1}),
            (this.options = Calendly._util.assign({}, e, this.options)),
        ...
        (e.prototype.getSource = function() {
          var e;
          return (
            (e = Calendly._url.stripQuery(this.url) + "?" + this.getParams()),
            this.filterConsentParam(e)
          );
        }),
        ...
        (e.prototype.getParams = function() {
          var e, t, n, o;
          (t = {embed_domain: this.getDomain(), embed_type: this.embedType}),
            (t = Calendly._util.assign(
              t,
        ...
        (e.prototype.getUtmParamsFromHost = function() {
          var e, t;
          return (
            (e = ["utm_campaign", "utm_source", "utm_medium", "utm_content", "utm_term"]),
            (t = Calendly._url.extractQueryStringParams(window.location.href)),
            Calendly._util.pick(t, e)
          );
        }),
        ...
        (e.prototype.getUtmParams = function() {
          ...
          return this.options.utm
            ? ((e = ["utmCampaign", "utmSource", "utmMedium", "utmContent", "utmTerm"]),
              Calendly._util.snakeCaseKeys(Calendly._util.pick(this.options.utm, e)))
            : null;
        }),
        (e.prototype.getPrefillParams = function() {
          ...
          if (
            ((t = ["name", "firstName", "lastName", "email"]),
            (n = Calendly._util.snakeCaseKeys(Calendly._util.pick(this.options.prefill, t))),

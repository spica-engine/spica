// following dependency removed the devDependencies of this package
// "@spica-server/passport": "workspace:*",
// it introduces circular dependency
// find a way to use passport testing module instead.
